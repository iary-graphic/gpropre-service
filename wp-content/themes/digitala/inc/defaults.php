<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            $theme_click_pen_to_edit_title = __('The Cost of Being Creative', 'digitala');


            if (apply_filters('colibri_page_builder/installed', false)) {
                $theme_click_pen_to_edit_title = __(
                    'Just click and start typing to change the site headline.',
                    'digitala'
                );
            }

            return $theme_click_pen_to_edit_title;
        });
    ...
    $digitala_theme_svg_icons = array(
		'fort-awesome'  => array(
		...
		'phone-2'         => array(
			'name'    => 'font-awesome/phone',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 545.5"><path d="M138.5 80c8.375 0 16.656 3.024 23.5 8.5l1 .5.5.5 64 66 1.5 1.5-.5.5c14.174 13.212 13.968 35.53.5 49l-32 32c4.92 11.277 18.33 40.02 44.5 65 26.358 25.16 53.932 39.467 65.5 45l31.5-31.5.5-.5c13.28-13.28 36.72-13.28 50 0l.5 1 65 65c13.28 13.28 13.28 36.22 0 49.5L405 481.5l-.5.5-.5.5c-15.01 12.867-36.04 17.486-55.5 11h-.5c-37.55-14.693-113.51-48.01-181.5-116C98.773 309.773 64.052 234.84 50.5 196c-.035-.1.034-.4 0-.5-6.703-18.434-1.915-39.738 13.5-54l-.5-.5 50-51.5.5-.5 1-.5c6.844-5.476 15.125-8.5 23.5-8.5zm0 32c-1.172 0-2.344.575-3.5 1.5L86.5 163l-.5.5-.5.5c-5.674 4.863-7.44 14.493-5 21 12.12 34.847 45.2 106.7 108.5 170 62.784 62.784 133.224 93.76 169.5 108 9.34 3.113 17.11 1.833 24.5-4.5l49-49c2.72-2.72 2.72-1.78 0-4.5l-65.5-65.5c-2.72-2.72-2.28-2.72-5 0l-40 40-7.5 7.5-10-4.5s-43.83-18.552-81-52.5l-3.5-3c-38.595-36.84-57-86-57-86l-3.5-10 7.5-7 40-40c1.966-1.966.874-3.6 1-3.5l-.5-.5-1-1-64-65.5c-1.156-.925-2.328-1.5-3.5-1.5z"/></svg>',
		),
		'phone-square'  => array(
		...
		'map-marker-light'    => array(
			'name'    => 'font-awesome/map-marker',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 545.5"><path d="M256 80c79.336 0 144 64.664 144 144 0 22.5-9.116 48.313-21.5 76.5s-28.314 58.098-44.5 86C301.628 442.306 269 489 269 489l-13 19-13-19s-32.628-46.694-65-102.5c-16.186-27.902-32.116-57.813-44.5-86S112 246.5 112 224c0-79.336 64.664-144 144-144zm0 32c-62.04 0-112 49.96-112 112 0 12.844 6.884 37.06 18.5 63.5s27.686 55.738 43.5 83c25.155 43.364 40.74 66.3 50 80 9.26-13.7 24.845-36.636 50-80 15.815-27.262 31.884-56.56 43.5-83S368 236.844 368 224c0-62.04-49.96-112-112-112zm0 80c17.673 0 32 14.327 32 32s-14.327 32-32 32-32-14.327-32-32 14.327-32 32-32z"/></svg>',
		),
		'envelope-open' => array(
		...
		'envelope-2'      => array(
			'name'    => 'font-awesome/envelope',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 545.5"><path d="M48 160h416v288H48V160zm69 32 139 92.5L395 192H117zm-37 14v210h352V206L265 317.5l-9 5.5-9-5.5z"/></svg>',
		),
		'facebook'      => array(
		...
		'facebook-2'      => array(
			'name'    => 'font-awesome/facebook-f',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1896.083"><path d="M959 12v264H802q-86 0-116 36t-30 108v189h293l-39 296H656v759H350V905H95V609h255V391q0-186 104-288.5T731 0q147 0 228 12z"/></svg>',
		),
		'twitter'       => array(
		...
		'twitter-x'       => array(
			...
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8l164.9-188.5L26.8 48h145.6l100.5 132.9L389.2 48zm-24.8 373.8h39.1L151.1 88h-42l255.3 333.8z"/></svg>',
		),
		'youtube'       => array(
		...
		'youtube-play'       => array(
			'name'    => 'font-awesome/youtube-play',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792.001 1896.083"><path d="m711 1128 484-250-484-253v503zm185-862q168 0 324.5 4.5T1450 280l73 4q1 0 17 1.5t23 3 23.5 4.5 28.5 8 28 13 31 19.5 29 26.5q6 6 15.5 18.5t29 58.5 26.5 101q8 64 12.5 136.5T1792 788v176q1 145-18 290-7 55-25 99.5t-32 61.5l-14 17q-14 15-29 26.5t-31 19-28 12.5-28.5 8-24 4.5-23 3-16.5 1.5q-251 19-627 19-207-2-359.5-6.5T336 1512l-49-4-36-4q-36-5-54.5-10t-51-21-56.5-41q-6-6-15.5-18.5t-29-58.5T18 1254q-8-64-12.5-136.5T0 1004V828q-1-145 18-290 7-55 25-99.5T75 377l14-17q14-15 29-26.5t31-19.5 28-13 28.5-8 23.5-4.5 23-3 17-1.5q251-18 627-18z"/></svg>',
		),
		'vimeo'         => array(
		...
		'instagram'       => array(
			'name'    => 'font-awesome/instagram',
			'content' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1536 1896.083"><path d="M1024 896q0-106-75-181t-181-75-181 75-75 181 75 181 181 75 181-75 75-181zm138 0q0 164-115 279t-279 115-279-115-115-279 115-279 279-115 279 115 115 279zm108-410q0 38-27 65t-65 27-65-27-27-65 27-65 65-27 65 27 27 65zM768 266q-7 0-76.5-.5t-105.5 0-96.5 3-103 10T315 297q-50 20-88 58t-58 88q-11 29-18.5 71.5t-10 103-3 96.5 0 105.5.5 76.5-.5 76.5 0 105.5 3 96.5 10 103T169 1349q20 50 58 88t88 58q29 11 71.5 18.5t103 10 96.5 3 105.5 0 76.5-.5 76.5.5 105.5 0 96.5-3 103-10 71.5-18.5q50-20 88-58t58-88q11-29 18.5-71.5t10-103 3-96.5 0-105.5-.5-76.5.5-76.5 0-105.5-3-96.5-10-103T1367 443q-20-50-58-88t-88-58q-29-11-71.5-18.5t-103-10-96.5-3-105.5 0-76.5.5zm768 630q0 229-5 317-10 208-124 322t-322 124q-88 5-317 5t-317-5q-208-10-322-124T5 1213q-5-88-5-317t5-317q10-208 124-322t322-124q88-5 317-5t317 5q208 10 322 124t124 322q5 88 5 317z"/></svg>',
		),
	...
	$digitala_theme_divider_style = array(
	...
	$digitala_title = "The Cost of Being Creative";
	$digitala_lorem_ipsum = "Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur, vim ad prima vivendum consetetur.";

	$front_hero_image = '/images/hero-background.jpg';
	if ( file_exists( get_template_directory() . '/assets' . $front_hero_image ) ) {
		$front_hero_background = $theme_directory_uri . '/resources' . $front_hero_image;
	} else {
		$front_hero_background = $theme_directory_uri . "/resources/images/beach-landscape-sea-water-nature-sand-1061655-pxhere.com.jpg";
	}

	$inner_hero_image = 'images/inner-hero-background.jpg';
	if ( file_exists( get_template_directory() . '/assets' . $inner_hero_image ) ) {
		$inner_hero_background = $theme_directory_uri . '/resources' . $inner_hero_image;
	} else {
		$inner_hero_background = $front_hero_background;
	}
	...
	return array(
		...
		"edit_this_text_in_customizer"      => $digitala_title,
		'lorem_ipsum'                       => $digitala_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(163, 199, 211)',
		'blog_post_excerpt_length'          => 13,
		'assets_js_key'                     => "digitalaFrontendData",

		'default_icon'                      => $digitala_theme_svg_icons['fort-awesome'],
		'icons'                             => $digitala_theme_svg_icons,
		'divider_style'                     => $digitala_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
		...
		'header_front_page'                 => array(
			...
			'header-menu' => array(
				...
				'props' => array(
					'hoverEffect' => array(
						'type'  => 'bordered-active-item bordered-active-item--bottom', // HOVER_EFFECT_TYPE_VALUES
						'group' => array(
							'border' => array(
								'transition' => 'effect-borders-grow grow-from-left' // HOVER_EFFECT_BORDER_TRANSITION_VALUES
							)
						)
					)
				)
			...
			"hero" => array(
				...
				"props"             => array(
					"heroSection" => array(
						"layout" => "textWithMediaOnRight" // [textOnly, textWithMediaOnLeft, textWithMediaOnRight]
					),
				),
				'image'             => array(
					'props'      => array(
						'enabledFrameOption' => true,
					...
					'style'      => array(
						'descendants' => array(
							'frameImage' => array(
								...
								'backgroundColor' => 'rgba(223,247,89,1)',
								'thickness'       => 3,
							),
						),
					),
					'localProps' => array(
						"url" => $theme_directory_uri . "/resources/images/hero-media.jpg"
					)
				),
				"style"             => array(
					'padding'         =>
					...
					"background" => array(
						'type'      => 'color',
						'color'     => 'rgba(16, 17, 24, 1)',
						'image'     => array(
							0 => array(
								'source' => array(
									'url'      => $front_hero_background,
									'gradient' => array(
										'steps' => array(
											0 => array(
												'color' => '#b721ff',
						...
						"video"     => array(
							...
							"internalUrl" => $theme_directory_uri . "/resources/videos/demo-video.mp4",
							"poster"      => array(
								'url' => $theme_directory_uri . "/resources/images/demo-video-cover.jpg"
							)
						),
						'overlay'   => array(
							'type'     => 'gradient',
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $digitala_theme_svg_icons['facebook-2'],
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $digitala_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $digitala_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $digitala_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $digitala_theme_svg_icons['map-marker-light'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $digitala_theme_svg_icons['phone-2'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $digitala_theme_svg_icons['envelope-2'],
